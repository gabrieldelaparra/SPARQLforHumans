...
{
    public static class TypeEntities
    {
        /// <summary>
        ...
        ///     Key: 17; Values[]: 298
        /// </summary>
        //public static Dictionary<int, int[]> GetTypeEntitiesDictionary(string inputFilename)
        //{
        //    var lines = FileHelper.GetInputLines(inputFilename);
        //    var subjectGroups = lines.GroupBySubject();

        //    return GetTypeEntitiesDictionary(subjectGroups);
        //}

        //public static Dictionary<int, int[]> GetTypeEntitiesDictionary(this IEnumerable<SubjectGroup> subjectGroups)
        //{
        //    var dictionary = new Dictionary<int, List<int>>();
        //    foreach (var subjectGroup in subjectGroups)
        //        dictionary.GetTypeEntitiesDictionary(subjectGroup);

        //    return dictionary.ToArrayDictionary();
        //}

        //private static void GetTypeEntitiesDictionary(this Dictionary<int, List<int>> dictionary, SubjectGroup subjectGroup)
        //{
