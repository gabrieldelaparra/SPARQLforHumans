...
namespace SparqlForHumans.Lucene.Indexing.Relations.Mappings
{
    ...
    /////     ```
    ///// </summary>
    public class PropertyRangeMapper : BaseOneToManyRelationMapper<int, int>
    {
        public PropertyRangeMapper(string inputFilename) : base(inputFilename)
        {
        }

        public PropertyRangeMapper(IEnumerable<SubjectGroup> subjectGroups) : base(subjectGroups)
        {
        }
