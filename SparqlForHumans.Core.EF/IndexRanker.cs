...
namespace SparqlForHumans.Core.EF
{
    ...
    //    public static void BuildNodesGraph(string triplesFilename)
    //    {
    ...
    //        using (var context = new GraphNodeDbContext())
    //        {
    ...
    //                    if (!entityNode.ConnectedNodes.Any(x => x.Value.Equals(objectId)))
    //                        entityNode.ConnectedNodes.Add(new ConnectedNode(objectId));
    //                }
    //                //list.Add(entityNode);
    //                nodeCount++;
    //            }
